...
<cfcomponent output="false" hint="Mailer via SQL Server Database Mail with CFMAIL fallback (tag-based)">
  ...
  <cffunction name="_summarySimple" access="private" returntype="string" output="false">
    ...
    <cfset hnew =   "<table role='presentation' cellpadding='0' cellspacing='0' border='0' width='600' style='max-width:600px;background:white;border:1px solid rgb(231, 233, 238);border-radius:12px;overflow:hidden;'>"
    & "          <tr>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>Request ID: </div>"
    & "            </td>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>" & requestId & "</div>"
    & "            </td>"
    & "          </tr>"

    & "          <tr>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>Faculty: </div>"
    & "            </td>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>" & facDisplay & "</div>"
    & "            </td>"
    & "          </tr>"

    & "          <tr>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>Craft: </div>"
    & "            </td>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>" & craft & "</div>"
    & "            </td>"
    ...
    & "          <tr>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>LDC: </div>"
    & "            </td>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>" & ldc & "</div>"
    & "            </td>"
    ...
    & "          <tr>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>Operation number: </div>"
    & "            </td>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>" & opnum & "</div>"
    & "            </td>"
    & "          </tr>"

    & "          <tr>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>Hours/week: </div>"
    & "            </td>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>" & hours & "</div>"
    & "            </td>"
    & "          </tr>"

    & "          <tr>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>Weeks: </div>"
    & "            </td>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>" & startDate & " to " & endDate & "</div>"
    & "            </td>"
    & "          </tr>"

    & "          <tr>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>Justification: </div>"
    & "            </td>"
    & "            <td style='padding:14px 16px;background: rgb(59, 110, 143);color:white;'>"
    & "              <div style='font-size:16px;font-weight:700;letter-spacing:.2px;'>" & justification & "</div>"
    & "            </td>"
  ...
  <cffunction name="_submitHtml" access="private" returntype="string" output="false">
    ...
    <cfset var url = "https://eagnmnwbc1db.usps.gov/ref/toolbox/flex/dashboard.html">
    <cfset var nm  = "">
    <cfset var h   = "">
